...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('[get-stock] total lignes:', allRows.length, '| premier editeur:', allRows[0]?.editeur, '| recherché:', editeur);
    let articles = allRows.filter(a => a.ref_neoludis && a.editeur.toLowerCase() === editeur.toLowerCase());
